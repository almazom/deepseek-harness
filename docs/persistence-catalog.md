...
<a id="sessionsemantic-map--log-only"></a>

#### `session/semantic-map` — log-only
...
Source: [`packages/session/session-semantic-map/src/types.ts:75`](../packages/session/session-semantic-map/src/types.ts)
