...
export const zh = {
  ...
  'queue.steerSmart': '智能插话发送',
  'queue.steerSmart.unavailable': '仅运行中可使用智能插话',
  'queue.steerSmartFailed': '智能插话失败，请重试。',
...
export const en = {
  ...
  'queue.steerSmart': 'Smart steer queued message',
  'queue.steerSmart.unavailable': 'Smart steer is available only while the agent is running',
  'queue.steerSmartFailed': 'Smart steer failed. Try again.',
