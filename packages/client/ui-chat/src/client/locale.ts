...
export const zh = {
  ...
  'message.think': '思考',
  'hooks.card.title': '钩子',
  'hooks.card.aria': '钩子遥测',
  'hooks.card.duration': '{n}ms',
  ...
  'message.turnMaxTokensEmpty': '输出 token 上限：本轮未生成任何回复文本',
  'message.turnMaxTokensMidWork': '输出 token 上限：回复在中途被截断',
...
export const en = {
  ...
  'message.compaction.commandTitle': 'compact',
  'message.think': 'Think',
  'hooks.card.title': 'Hooks',
  'hooks.card.aria': 'Hook telemetry',
  'hooks.card.duration': '{n}ms',
  ...
  'message.turnMaxTokensEmpty': 'Output token limit reached before any reply text was produced',
  'message.turnMaxTokensMidWork': 'Output token limit reached; the reply was cut off mid-turn',
