...
export const zh = {
  ...
  'option.autoDecide': '集体决策（brainstorm）',
  'countdown.label': '{seconds}s',
  'countdown.hint': '倒计时结束将自动采用集体决策（brainstorm）',
...
export const en = {
  ...
  'option.autoDecide': 'Collective decision (brainstorm)',
  'countdown.label': '{seconds}s',
  'countdown.hint': 'The countdown ends by taking the collective brainstorm decision.',
