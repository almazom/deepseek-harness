...
export const zh = {
  ...
  'day.yesterday': '昨天',
  'day.twoDaysAgo': '前天',
  'day.threeDaysAgo': '大前天',
  'day.lastWeek': '上周',
  'day.lastMonth': '上个月',
  'orderBy.label': '排序方式',
  'orderBy.manual': '手动排序',
  'orderBy.updated': '最近更新',
  'filter.active': '仅显示活跃会话',
  'sessions.expand': '展开其余 {n} 个会话',
  'sessions.collapse': '收起',
  'sessions.pager.aria': '会话分页',
  'sessions.pager.prev': '上一页',
  'sessions.pager.next': '下一页',
  'sessions.pager.status': '会话 {from}–{to}，共 {total} 个',
...
export const en = {
  ...
  'day.twoDaysAgo': 'Two days ago',
  'day.threeDaysAgo': 'Three days ago',
  'day.lastWeek': 'Last week',
  'day.lastMonth': 'Last month',
  'orderBy.label': 'Order by',
  'orderBy.manual': 'Manual',
  'orderBy.updated': 'Last updated',
  'filter.active': 'Show active only',
  'sessions.expand': 'Show {n} more sessions',
  'sessions.collapse': 'Show less',
  'sessions.pager.aria': 'Sessions pagination',
  'sessions.pager.prev': 'Previous page',
  'sessions.pager.next': 'Next page',
  'sessions.pager.status': 'Sessions {from}–{to} of {total}',
