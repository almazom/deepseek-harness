...
import type { QueueAdvisorRequest } from '@deepseek-ai/dsh-smart-steer/dispatcher'
import SessionProjectionRegistry from '@deepseek-ai/dsh-session-projection'
import * as commandSide from '@deepseek-ai/dsh-smart-steer'
import { latestHumanProjectionDefinition } from '../src/latest-human.ts'
...
describe('@deepseek-ai/dsh-smart-steer registration', () => {
  it('registers both spellings with Loader-safe exports and disposes them', async () => {
    const test = await harness()
    expect(commandSide.name).toBe('smart_steer')
    ...
    expect(listed).toContainEqual({
      definitionId: '@deepseek-ai/dsh-smart-steer/side',
      name: 'side',
      description: 'Ask the advisor a side question about the current conversation',
      input: { hint: '<question>' },
    })
    expect(listed).toContainEqual({
      definitionId: '@deepseek-ai/dsh-smart-steer/btw',
      name: 'btw',
