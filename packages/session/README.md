...
| [`command-side/`](command-side/README.md) | `/side` (`/btw`) slash command that starts one advisor side run over the latest queued message | `ctx.queueAdvisor` (optional, consumer) |
