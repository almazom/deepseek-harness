#!/usr/bin/env node
/**
 * Stable link target for the `mail-*` bins, forwarding to the build product.
 *
 ...
 * @module @deepseek-ai/dsh-mail/bin-link
 */
...
if (!existsSync(fileURLToPath(entry))) {
  process.stderr.write('mail: lib/bin.js is missing — run `pnpm run build` before using the mail binaries\n')
  process.exit(1)
}
